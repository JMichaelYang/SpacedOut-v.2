...
public class NetworkSpawnPool : MonoBehaviour
{
	static Dictionary<string, NetworkSpawnPool> s_pools = new Dictionary<string, NetworkSpawnPool>();
	...
	static public NetworkSpawnPool GetPoolByName(string name)
	{
		return s_pools[name];
	}
